...
import org.arthan.support.entity.Attachment;
import org.arthan.support.entity.Ticket;
...
public class TicketServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "create":
                showTicketForm(response, request);
                break;
            case "view":
    ...
    private void showTicketForm(HttpServletResponse response, HttpServletRequest request)
            ...
            throws IOException
    {
        ...
        ByteArrayOutputStream outputStreamForAttachment = new ByteArrayOutputStream();
        ...
        {
            outputStreamForAttachment.write(bytes, 0, read);
        }

        Attachment attachment = new Attachment();
        attachment.setName(filePart.getSubmittedFileName());
        attachment.setContents(outputStreamForAttachment.toByteArray());
